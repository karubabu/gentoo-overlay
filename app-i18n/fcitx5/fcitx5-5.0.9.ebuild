...
LICENSE="LGPL-2.1+"
SLOT="5"
IUSE="test coverage +gtk2 +gtk3 +enchant +x11 wayland dbus doc +server +keyboard +systemd +xdgautostart flatpak_icon +emoji +libuuid"
RDEPEND="
...
src_configure() {
	local mycmakeargs=(
		...
		-DUSE_FLATPACK_ICON=$(usex flatpak_icon)
