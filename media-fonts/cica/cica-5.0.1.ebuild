...
# Portage.
MY_P="Cica"
SRC_URI="https://github.com/miiton/Cica/releases/download/v${PV}/${MY_P}_v${PV}_with_emoji.zip -> ${MY_P}.zip"


# License of the package.  This must match the name of file(s) in
# /usr/portage/licenses/.  For complex license combination see the developer
# docs on gentoo.org for details.
LICENSE="Apache-2.0 custom:OFL MIT CC-BY-4.0 UbuntuFontLicense-1.0"
