...
RDEPEND="${DEPEND}"
EGO_PN="github.com/imthaghost/${PN}"
...
"github.com/bogem/id3v2 v1.1.3/go.mod"
...
"github.com/torden/go-strutil v0.1.5/go.mod"
...
SRC_URI="https://github.com/imthaghost/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
